...
const rawProducts: Product[] = [
...

  {
    ...
    slots: [
      ...
      { name: "Ultra Rare (UR)", odds: "1:12", oddsNum: 0.083, avgValue: 6 },
      { name: "Illustration Rare (IR)", odds: "1:9", oddsNum: 0.111, avgValue: 10 },
  ...
  },
  {
    ...
    slots: [
      ...
      { name: "Ultra Rare (UR)", odds: "1:12", oddsNum: 0.083, avgValue: 5.5 },
      { name: "Illustration Rare (IR)", odds: "1:9", oddsNum: 0.111, avgValue: 9.5 },
      { name: "Special Illustration Rare (SIR)", odds: "1:81", oddsNum: 0.0123, avgValue: 80 },
      { name: "Mega Hyper Rare (MHR)", odds: "1:1786", oddsNum: 0.00056, avgValue: 320 },
    ],
    notes: "ME-era tiers from public Perfect Order pull-rate writeups (DR 1:5, UR 1:12, IR 1:9, SIR 1:81, MHR Mega Zygarde ~1:1786). Slot avg $ are estimates — tag as estimate, not official TPC odds. Near-floor pack pricing Sep 2026.",
  },
  {
    ...
    slots: [
      ...
      { name: "Ultra Rare (UR)", odds: "~1:15", oddsNum: 0.067, avgValue: 7 },
      { name: "Illustration Rare (IR)", odds: "~1:9", oddsNum: 0.111, avgValue: 11 },
  ...
  // ========== 30TH CELEBRATION (EN Sep 2026) ==========
  {
    ...
    slots: [
      ...
      { name: "Double Rare expected", odds: "~2.0", oddsNum: 1, avgValue: 2.8 },
      { name: "Illustration Rare expected", odds: "~1.67", oddsNum: 1, avgValue: 19.7 },
      { name: "Classic Collection expected", odds: "~0.9", oddsNum: 1, avgValue: 23.4 },
      { name: "SIR expected", odds: "~0.49", oddsNum: 1, avgValue: 31.6 },
      { name: "Futuristic Rare expected", odds: "~0.1", oddsNum: 1, avgValue: 13.0 },
      { name: "Promo / accessories (soft)", odds: "included", oddsNum: 1, avgValue: 12 },
    ],
    notes: "9 packs; full-art Nidorina promo; 16 foil energy; sleeves; dice; coin; dividers; player's guide; Live code. MSRP $49.99; default uses secondary ~$157.86. Pack EV slots from post-launch EN consensus (Wargamer/Tommy13 4063 packs Sep 17; TCGTalk via Anderson 652 Sep 16; DigitalTQ 420 Sep 16) + HobbyBin price guide / Pitt Poke Research sealed Sep 17; implied pack EV ~$12.15. RGB Mew omitted (unknown). Day-1 rates/prices are volatile — not financial advice.",
  },
  {
    id: "poke-30th-pc-etb",
    category: "pokemon",
    ...
    slots: [
      ...
      { name: "Double Rare expected", odds: "~2.44", oddsNum: 1, avgValue: 3.4 },
      { name: "Illustration Rare expected", odds: "~2.04", oddsNum: 1, avgValue: 24.1 },
      { name: "Classic Collection expected", odds: "~1.1", oddsNum: 1, avgValue: 28.6 },
      { name: "SIR expected", odds: "~0.59", oddsNum: 1, avgValue: 38.6 },
      { name: "Futuristic Rare expected", odds: "~0.12", oddsNum: 1, avgValue: 15.6 },
  ...
  },
  {
    ...
    slots: [
      ...
      { name: "Double Rare expected", odds: "~1.33", oddsNum: 1, avgValue: 1.9 },
      { name: "Illustration Rare expected", odds: "~1.11", oddsNum: 1, avgValue: 13.1 },
      { name: "Classic Collection expected", odds: "~0.6", oddsNum: 1, avgValue: 15.6 },
      { name: "SIR expected", odds: "~0.32", oddsNum: 1, avgValue: 21.1 },
      { name: "Futuristic Rare expected", odds: "~0.07", oddsNum: 1, avgValue: 9.1 },
    ],
    notes: "6 packs; no promo. Best pack-density SKU after ETB for EV calc. MSRP $26.94; default uses secondary ~$121.64. Pack EV slots from post-launch EN consensus (Wargamer/Tommy13 4063 packs Sep 17; TCGTalk via Anderson 652 Sep 16; DigitalTQ 420 Sep 16) + HobbyBin price guide / Pitt Poke Research sealed Sep 17; implied pack EV ~$12.15. RGB Mew omitted (unknown). Day-1 rates/prices are volatile — not financial advice.",
  },
  {
    id: "poke-30th-poster",
    category: "pokemon",
    ...
    slots: [
      ...
      { name: "Double Rare expected", odds: "~0.67", oddsNum: 1, avgValue: 0.9 },
      { name: "Illustration Rare expected", odds: "~0.56", oddsNum: 1, avgValue: 6.6 },
      { name: "Classic Collection expected", odds: "~0.3", oddsNum: 1, avgValue: 7.8 },
      { name: "SIR expected", odds: "~0.16", oddsNum: 1, avgValue: 10.5 },
      { name: "Futuristic Rare expected", odds: "~0.03", oddsNum: 1, avgValue: 3.9 },
      { name: "Promo / accessories (soft)", odds: "included", oddsNum: 1, avgValue: 18 },
    ],
    notes: "3 packs; Articuno / Zapdos / Moltres promos; two-sided poster. MSRP $14.99; default uses early secondary ~$52.99. Pack EV slots from post-launch EN consensus (Wargamer/Tommy13 4063 packs Sep 17; TCGTalk via Anderson 652 Sep 16; DigitalTQ 420 Sep 16) + HobbyBin price guide / Pitt Poke Research sealed Sep 17; implied pack EV ~$12.15. RGB Mew omitted (unknown). Day-1 rates/prices are volatile — not financial advice.",
  },
  {
    ...
    slots: [
      ...
      { name: "SIR expected", odds: "~0.16", oddsNum: 1, avgValue: 10.5 },
      { name: "Futuristic Rare expected", odds: "~0.03", oddsNum: 1, avgValue: 3.9 },
      { name: "Promo / accessories (soft)", odds: "included", oddsNum: 1, avgValue: 8 },
    ],
    notes: "3 packs; Alolan Exeggutor foil promo; matching sticker sheet. MSRP $14.99; default uses early secondary ~$44.32. Pack EV slots from post-launch EN consensus (Wargamer/Tommy13 4063 packs Sep 17; TCGTalk via Anderson 652 Sep 16; DigitalTQ 420 Sep 16) + HobbyBin price guide / Pitt Poke Research sealed Sep 17; implied pack EV ~$12.15. RGB Mew omitted (unknown). Day-1 rates/prices are volatile — not financial advice.",
  },
  {
    ...
    notes: "3 packs; Lucario foil promo; matching sticker sheet. MSRP $14.99; default uses early secondary ~$38.3. Pack EV slots from post-launch EN consensus (Wargamer/Tommy13 4063 packs Sep 17; TCGTalk via Anderson 652 Sep 16; DigitalTQ 420 Sep 16) + HobbyBin price guide / Pitt Poke Research sealed Sep 17; implied pack EV ~$12.15. RGB Mew omitted (unknown). Day-1 rates/prices are volatile — not financial advice.",
  },
  {
    ...
    slots: [
      ...
      { name: "Double Rare expected", odds: "~0.89", oddsNum: 1, avgValue: 1.2 },
      { name: "Illustration Rare expected", odds: "~0.74", oddsNum: 1, avgValue: 8.7 },
      { name: "Classic Collection expected", odds: "~0.4", oddsNum: 1, avgValue: 10.4 },
      { name: "SIR expected", odds: "~0.22", oddsNum: 1, avgValue: 14.0 },
      { name: "Futuristic Rare expected", odds: "~0.04", oddsNum: 1, avgValue: 5.2 },
      { name: "Promo / accessories (soft)", odds: "included", oddsNum: 1, avgValue: 10 },
    ],
    notes: "4 packs; Sylveon ex promo + oversize card. MSRP $21.99; default uses early secondary ~$78.36. Pack EV slots from post-launch EN consensus (Wargamer/Tommy13 4063 packs Sep 17; TCGTalk via Anderson 652 Sep 16; DigitalTQ 420 Sep 16) + HobbyBin price guide / Pitt Poke Research sealed Sep 17; implied pack EV ~$12.15. RGB Mew omitted (unknown). Day-1 rates/prices are volatile — not financial advice.",
  },
  {
    ...
    notes: "4 packs; Greninja ex promo + oversize card. MSRP $21.99; default uses early secondary ~$54.69. Pack EV slots from post-launch EN consensus (Wargamer/Tommy13 4063 packs Sep 17; TCGTalk via Anderson 652 Sep 16; DigitalTQ 420 Sep 16) + HobbyBin price guide / Pitt Poke Research sealed Sep 17; implied pack EV ~$12.15. RGB Mew omitted (unknown). Day-1 rates/prices are volatile — not financial advice.",
  },
  {
    ...
    slots: [
      ...
      { name: "Double Rare expected", odds: "~0.44", oddsNum: 1, avgValue: 0.6 },
      { name: "Illustration Rare expected", odds: "~0.37", oddsNum: 1, avgValue: 4.4 },
      { name: "Classic Collection expected", odds: "~0.2", oddsNum: 1, avgValue: 5.2 },
      { name: "SIR expected", odds: "~0.11", oddsNum: 1, avgValue: 7.0 },
      { name: "Futuristic Rare expected", odds: "~0.02", oddsNum: 1, avgValue: 2.6 },
      { name: "Promo / accessories (soft)", odds: "included", oddsNum: 1, avgValue: 8 },
    ],
    notes: "2 packs; Eevee foil promo; commemorative coin. MSRP $9.99; default uses early secondary ~$27.49. Pack EV slots from post-launch EN consensus (Wargamer/Tommy13 4063 packs Sep 17; TCGTalk via Anderson 652 Sep 16; DigitalTQ 420 Sep 16) + HobbyBin price guide / Pitt Poke Research sealed Sep 17; implied pack EV ~$12.15. RGB Mew omitted (unknown). Day-1 rates/prices are volatile — not financial advice.",
  },
  {
    id: "poke-30th-binder",
    category: "pokemon",
    ...
    slots: [
      ...
      { name: "Double Rare expected", odds: "~1.11", oddsNum: 1, avgValue: 1.6 },
      { name: "Illustration Rare expected", odds: "~0.93", oddsNum: 1, avgValue: 11.0 },
      { name: "Classic Collection expected", odds: "~0.5", oddsNum: 1, avgValue: 13.0 },
      { name: "SIR expected", odds: "~0.27", oddsNum: 1, avgValue: 17.6 },
      { name: "Futuristic Rare expected", odds: "~0.06", oddsNum: 1, avgValue: 7.8 },
      { name: "Promo / accessories (soft)", odds: "included", oddsNum: 1, avgValue: 15 },
    ],
    notes: "5 packs + 9-pocket portfolio. Possible delay to 2026-12-04 reported; verify on pokemon.com before launch. MSRP $31.99; default uses early secondary ~$81.44. Pack EV slots from post-launch EN consensus (Wargamer/Tommy13 4063 packs Sep 17; TCGTalk via Anderson 652 Sep 16; DigitalTQ 420 Sep 16) + HobbyBin price guide / Pitt Poke Research sealed Sep 17; implied pack EV ~$12.15. RGB Mew omitted (unknown). Day-1 rates/prices are volatile — not financial advice.",
  },
  {
    ...
    notes: "2 packs + sticker sheet + art card. Multiple art variants (Day/Night Pikachu, Espeon, Umbreon, etc.). MSRP $9.99; default uses early secondary ~$65.65. Pack EV slots from post-launch EN consensus (Wargamer/Tommy13 4063 packs Sep 17; TCGTalk via Anderson 652 Sep 16; DigitalTQ 420 Sep 16) + HobbyBin price guide / Pitt Poke Research sealed Sep 17; implied pack EV ~$12.15. RGB Mew omitted (unknown). Day-1 rates/prices are volatile — not financial advice.",
  },
  {
    ...
    slots: [
      ...
      { name: "Double Rare expected", odds: "~6.44", oddsNum: 1, avgValue: 9.0 },
      { name: "Illustration Rare expected", odds: "~5.37", oddsNum: 1, avgValue: 63.4 },
      { name: "Classic Collection expected", odds: "~2.9", oddsNum: 1, avgValue: 75.4 },
      { name: "SIR expected", odds: "~1.57", oddsNum: 1, avgValue: 101.8 },
      { name: "Futuristic Rare expected", odds: "~0.32", oddsNum: 1, avgValue: 41.6 },
      { name: "Promo / accessories (soft)", odds: "included", oddsNum: 1, avgValue: 40 },
      { name: "Classic Collection 3-card pack (soft)", odds: "included", oddsNum: 1, avgValue: 7.5 },
    ],
    notes: "29× 30th Celebration boosters + 1 Classic Collection 3-card pack (soft ~$5–10, modeled at $7.50); Pikachu ex (day) + Espeon ex; playmat/sleeves/deck box. MSRP $179.99; default uses early secondary ~$620.73. Pack EV slots from post-launch EN consensus (Wargamer/Tommy13 4063 packs Sep 17; TCGTalk via Anderson 652 Sep 16; DigitalTQ 420 Sep 16) + HobbyBin price guide / Pitt Poke Research sealed Sep 17; implied pack EV ~$12.15. RGB Mew omitted (unknown). Day-1 rates/prices are volatile — not financial advice.",
  },
  {
    ...
    notes: "29 regular packs + 1 Classic Collection pack (soft ~$5–10, modeled at $7.50); Pikachu ex (night) + Umbreon ex. MSRP $179.99; default uses early secondary ~$661.35. Pack EV slots from post-launch EN consensus (Wargamer/Tommy13 4063 packs Sep 17; TCGTalk via Anderson 652 Sep 16; DigitalTQ 420 Sep 16) + HobbyBin price guide / Pitt Poke Research sealed Sep 17; implied pack EV ~$12.15. RGB Mew omitted (unknown). Day-1 rates/prices are volatile — not financial advice.",
  },
